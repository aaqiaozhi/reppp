				...
				<div class="row">
					...
					<form action="userinfo/${msg }.do" name="Form" id="Form" method="post">
						...
						<tr>
								...
								<td>
								<select class="chosen-select form-control" name="TML_LEVEL" id="TML_LEVEL" placeholder="请选择等级" style="vertical-align:top;"  title="请选择等级" style="width:98%;" >
								
									<c:forEach items="${list_lv}" var="level">
										<option value="${level.TML_ID }" >${level.TML_LEVEL }</option>
									</c:forEach>
									</select>
								</td>
