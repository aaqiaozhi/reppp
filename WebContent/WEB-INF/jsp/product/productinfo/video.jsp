		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="productinfo/saveVideo.do" name="Form" id="Form" method="post">
					
					<input type="hidden" name="TPI_LARGE" id="TPI_LARGE"/>
					
					<input type="hidden" value="${pd.TP_ID}" id="TP_ID" name="TP_ID"/>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(document).ready(function(){
			...
			$("#uploadify1").uploadify({
				...
				'folder'	:	"<%=basePath%>uploadFiles/uploadFile/video",//上传文件存放的路径,请保持与uploadFile.jsp中PATH的值相同
				'queueId'	:	"fileQueue",
				...
				'buttonText':	"files",
				'scriptData':	{'uploadPath':'/upload/uploadVideo/video/'},//这个参数用于传递用户自己的参数，此时'method' 必须设置为GET, 后台可以用request.getParameter('name')获取名字的值
				'method'	:	"GET",
				...
				'onAllComplete' : function(event,data) {
					//alert(str);	//全部上传完毕执行
					$("#TPI_LARGE").val('/upload/uploadVideo/video/'+str);
					$("#Form").submit();
					$("#zhongxin").hide();
					$("#zhongxin2").show();
		    	},
