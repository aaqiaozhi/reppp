						...
						<div class="widget-box">
							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<div   id="TI_CONTENT"  style="display:none">
								    ${pd.TP_DESP}
								</div>
...
$(top.hangge());
	...
	//	$("#zhongxin").hide();
		...
		var TP_DESP = $("#CONTENT").val();
	
		
		$.ajax({
			type: "POST",
			url: locat+'/productinfo/goEditproduct.do?tm='+new Date().getTime(),
	    	data: {TP_ID:TP_ID,TP_DESP:TP_DESP},
			dataType:'json',
			cache: false,
