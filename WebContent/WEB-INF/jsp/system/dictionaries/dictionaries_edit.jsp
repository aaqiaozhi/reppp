				...
				<div class="row">
					...
					<form action="dictionaries/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="margin-top:15px;">
							...
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">值:</td>
								<td><input type="text" name="NAME_EN" id="NAME_EN" value="${pd.NAME_EN}" maxlength="50" placeholder="这里输入值" title="值" style="width:98%;"/></td>
							</tr>
							<tr>
