								...
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td id="juese">
											<select class="chosen-select form-control" name="ROLE_ID" id="role_id" data-placeholder="请选择部门" style="vertical-align:top;" style="width:98%;" >
											<option value=""></option>
										...
										<tr>
											...
											<td id="jueses">
											<select class="chosen-select form-control" name="ROLE_IDS" id="role_ids" data-placeholder="请选择职位" style="vertical-align:top;" style="width:98%;" >
											<option value=""></option>
											<c:forEach items="${roleLists}" var="roles">
												<option value="${roles.ROLE_ID }" <c:if test="${roles.ROLE_ID == pd.ROLE_IDS }">selected</c:if>>${roles.ROLE_NAME }</option>
											</c:forEach>
											</select>
											</td>
										</tr>
										...
										<c:if test="${fx == 'head'}">
											<input name="ROLE_IDS" id="role_ids" value="${pd.ROLE_IDS }" type="hidden" />
										</c:if>
										<tr>
