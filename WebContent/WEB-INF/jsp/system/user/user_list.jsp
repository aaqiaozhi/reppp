						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="ROLE_ID" id="role_id" data-placeholder="请选择部门" style="vertical-align:top;width: 120px;">
									<option value=""></option>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="ROLE_IDS" id="role_ids" data-placeholder="请选择职位" style="vertical-align:top;width: 120px;">
									<option value=""></option>
									<option value="">全部</option>
									<c:forEach items="${roleLists}" var="roles">
										<option value="${roles.ROLE_ID }" <c:if test="${pd.ROLE_IDS==roles.ROLE_ID}">selected</c:if>>${roles.ROLE_NAME }</option>
									</c:forEach>
								  	</select>
								</td>
								<c:if test="${QX.cha == 1 }">
								...
								<c:when test="${not empty userList}">
									...
									<c:forEach items="${userList}" var="user" varStatus="vs">
										...
										<tr>
											...
											<td class="center">${user.ROLE_NAME } - ${user.ROLE_NAMES }</td>
