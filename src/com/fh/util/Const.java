...
//	public static final String DEPARTMENT_ID = "DEPARTMENT_ID";				//当前用户拥有的最高部门权限
	...
	public static final String FILEPATHFILEOA = "/upload/uploadFile/";	//文件上传路径(oa管理)
	
	public static final String FILEPATH_IMG = "/upload/uploadImg/";	//文件上传路径(图片管理)
	public static final String FILEPATH_VIDEO = "/upload/uploadVideo/";	//文件上传路径(视频)
	...
	public static String PICTURE_PATH="F:/Project/Project";
